...
class CodOrderEmail extends Notification
{
     ...
     * @return void
     */
    public function __construct($order,$customer,$address,$tracking,$carrier,$delivery_date,$support_email)
    {
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('Tracking Number: '.$this->tracking)
            ->line('Carrier: '.$this->carrier)
            ->line('Delivered Date: '.$this->delivery_date)
            ->line('We hope your shopping experience with us was exceptional, and your product arrived in perfect condition. If you have any feedback or questions about your order, please donWe’t hesitate to reach out to our customer support team at '.$this->support_email )
