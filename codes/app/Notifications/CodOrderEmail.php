...
class CodOrderEmail extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                        ...
                        // ->line('This email is to inform you that we have received your cash on delivery order for '.Config::get('icrm.currency.icon').number_format($this->order->order_total, 2).'/-')
