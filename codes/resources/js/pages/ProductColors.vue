<template>
    <div>
        ...
        <div class="container mx-auto my-2 px-4">
            ...
            <div class="mt-6">
              <a class="items-center gap-2 px-4 py-2 text-base font-bold text-center text-white align-middle transition-all rounded-lg cursor-pointer bg-gray-800 hover:bg-black hover:text-white">
                <i class="fi fi-rr-arrow-left text-base w-4 h-4"></i>
                  Back
              </a>
            </div>
            ...
            <div class="block">
                <div class="grid w-full grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4"
                    ...
                    <div v-for="(color, index) in product_colors"
