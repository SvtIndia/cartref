        ...
        <div class="block">
          <div class="flex flex-wrap items-center justify-between py-4">
            <div class="flex flex-wrap text-base text-gray-700 gap-2">
              ...
              <div>
                <button :disabled="!pagination.prev_page_url" @click="fetchWishlist(pagination.prev_page_url)" title="Previous" class="border border-transparent rounded-full hover:bg-orange-400 disabled:opacity-50">
                  <i class="fi fi-rr-angle-small-left text-xl px-1 py-2"></i>
                </button>
                <button :disabled="!pagination.next_page_url" @click="fetchWishlist(pagination.next_page_url)" title="Next" class="border border-transparent rounded-full hover:bg-orange-400 disabled:opacity-50">
            ...
            <div class="clear-right overflow-x-auto">
              <div class="table border-solid border border-gray-500 w-full">
                ...
                <div v-for="(wishlist, index) in wishlists" v-bind:key="index"
                     class="table-row table-body hover:bg-orange-100 bg-white">
