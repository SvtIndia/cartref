                        ...
                        <div class="md:flex mb-3">
                            <div class="mb-5 md:w-1/2 w-full mx-2 my-1">
                                <label for="sub_category" class="block mb-2 text-sm font-bold text-gray-900"
                                    title="The name is how it appears on your site.">SubCategory <span
                            ...
                            <div class="table border-solid border border-gray-500 w-full">
                                ...
                                <div v-for="(c, index) in sub_category" v-bind:key="index"
                                    ...
                                    <div class="table-cell border-t border-l border-gray-500 text-sm px-1 text-center">
                                        <img @click="imageModal($store.state.storageUrl + c.image)"
                                            class="w-14 h-14 border rounded-[50%]" :src="$store.state.storageUrl + c.image"
                                            :alt="c.name">
                                    </div>
                                    <div
                                    ...
                                    <div
                                        ...
                                        <div class="font-normal text-gray-900">
                                            {{ formatSimpleDate(c.updated_at) + ' at ' + formatTime(c.updated_at) }}
                                        </div>
                                    </div>
                                    <div
