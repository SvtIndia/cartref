...
<section class="appear-animate fadeIn appear-animation-visible home-product" data-animation-options="{
    ...
    <div class="container">
        <h2 class="title title-center">Recently Viewed</h2>
        <div class="owl-carousel owl-theme owl-nav-full owl-shadow-carousel owl-loaded owl-drag" data-owl-options="{
            ...
            <div class="owl-stage-outer">
                <div class="owl-stage"
                    style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1460px;">
                            ...
                            <div class="product-details">
                                ...
                                <div class="product-price">
                                    <ins class="new-price">{{ Config::get('icrm.currency.icon') }}{{
                                        $product->offer_price }}</ins><del class="old-price">{{
                                        Config::get('icrm.currency.icon') }}{{ $product->mrp }}</del>
                                ...
                                <div class="product-variations">
                                    ...
                                    <a class="color @if($key == 0) @endif"
                                        data-src="{{ Voyager::image($productcolor->main_image) }}"
                                        href="{{ route('product.slug', ['slug' => $product->slug, 'color' => $productcolor->color]) }}"
                                        style="background-color: {{ $productcolor->color }}"></a>
                                    @endforeach
                                </div>
                                @endif
                                @endif --}}
