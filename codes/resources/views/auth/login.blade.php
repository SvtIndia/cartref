    ...
    <div class="form-box">
        <div class="tab tab-nav-simple tab-nav-boxed form-tab">
            <ul class="nav nav-tabs nav-fill align-items-center border-no justify-content-center mb-5" role="tablist">
                <li class="nav-item">
                    <a class="nav-link @if(Session::get('login') == true OR Session::get('register') == false) active @endif border-no lh-1 ls-normal" href="#signin">Login</a>
                </li>
                <li class="delimiter">or</li>
                <li class="nav-item">
                    <a class="nav-link @if(Session::get('register') == true) active @endif border-no lh-1 ls-normal" href="#register">Register</a>
                </li>
            </ul>
            <div class="tab-content">
                ...
                <div class="tab-pane @if(Session::get('register') == true) active in @endif" id="register">
                    <form action="{{  route('register') }}" method="post">
                        ...
                        <div class="form-group mb-3">
                            <input type="text" class="form-control" name="mobile" value="{{ old('mobile') }}" placeholder="Your Contact Number *"
                                required />
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <input type="text" class="form-control" name="gst_number" value="{{ old('gst_number') }}" placeholder="Your Company GST Number *"
                                required />
                        </div>
                        @endif
