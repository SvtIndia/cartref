...
@section('meta-seo')
    <title>{{ Config::get('seo.register.title') }}</title>
    <meta name="keywords" content="{{ Config::get('seo.register.keywords') }}">
    <meta name="description" content="{{ Config::get('seo.register.description') }}">
@endsection
