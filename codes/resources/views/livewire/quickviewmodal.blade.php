                    ...
                    <div class="product product-single row product-popup">
                        <div class="col-md-6">
                            <div class="product-gallery">
                                <div
                                    class="product-single-carousel owl-carousel owl-theme owl-nav-inner owl-loaded owl-drag">

                                    <div class="owl-stage-outer">
                                        <div class="owl-stage"
                                            style="transform: translate3d(0px, 0px, 0px); transition: all 0.5s ease 0s;">

                                            <div class="owl-item active">
                                                <figure class="product-image">
                                                    <img src="{{ Voyager::image($this->qproductimage) }}"
                                                        data-zoom-image="{{ Voyager::image($this->qproductimage) }}"
                                                        alt="{{ $this->qproduct->name }}">
                                                </figure>
                                            </div>
                                    ...
                                    <div class="owl-nav disabled">
                                        <button type="button" title="presentation" class="owl-prev disabled"><i
                                                class="d-icon-angle-left"></i></button>
                                        <button type="button" title="presentation" class="owl-next disabled"><i
                                                class="d-icon-angle-right"></i></button>
                                    </div>
                            ...
                            <div class="product-details scrollable pr-0 pr-md-3">
                                <a href="{{ route('product.slug', ['slug' => $this->qproduct->slug]) }}">
                                    <h1 class="product-name mt-0">
                                        {{ $this->qproduct->getTranslatedAttribute('name', App::getLocale(), 'en') }}
                                    </h1>
                                </a>
                        ...
                        <button title="Close (Esc)" wire:click="displayfalse" type="button"
