                        ...
                        <div class="col-lg-7 mb-6 mb-lg-0 pr-lg-4">
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    ...
                                    <input type="text" class="form-control @error('deliverypincode') error @enderror btn-disabled" wire:model.debounce.1s="deliverypincode" required="" readonly disabled/>
                                </div>
                                <div class="col-xs-6">
                                    <label>Town / City <span class="required">*</span></label>
                                    @error('city') <span class="error">{{ $message }}</span> @enderror
                                    <input type="text" class="form-control @error('city') error @enderror btn-disabled" wire:model.defer="city" required="" readonly disabled/>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <input type="text" class="form-control @error('state') error @enderror btn-disabled" wire:model.defer="state" required="" readonly disabled/>
                                </div>
                                <div class="col-xs-6">
                                ...
                                <div class="summary pt-5">
                                    ...
                                    <table class="order-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="summary-subtotal">
                                                ...
                                                @if ($this->discount > 0)
                                                    <tr class="discount">
                                                        <td class="product-name">Discount ({{ Session::get('appliedcouponcode') }} coupon applied) <span class="d-icon-cancel" title="Remove coupon" style="color: blue;" wire:click="removecoupon"></span></td>
                                                        <td class="product-total text-body">-{{ Config::get('icrm.currency.icon') }} {{ $this->discount }}</td>
                                                    </tr>
                                                @endif
                                                <tr>
                                                ...
                                                @if (Config::get('icrm.tax.type') == 'fixed')
                                                    @if ($this->tax > 0)
                                                        <tr>
                                                            <td class="product-name">{{ Config::get('icrm.tax.name') }} <span class="product-quantity">({{ Config::get('icrm.tax.fixedtax.perc') }}%)</span></td>
                                                            <td class="product-total text-body" style="color: green !important;">+{{ config::get('icrm.currency.icon') }} {{ number_format($this->tax, 2) }}</td>
                                                        </tr>
                                                    @else
                                                        <tr>
                                                            <td class="product-name" style="color: green">Inclusive of taxes</td>
                                                            <td></td>
                                                        </tr>
                                                    @endif
                                                @endif
                                    ...
                                    @if (Config::get('icrm.order_methods.cod') == 1)
                                        @if ($this->cod == true)
                                            <div class="form-checkbox mt-4 mb-5" wire:click="codneeded">
                                                <input type="checkbox" class="custom-checkbox" disabled @if(Session::get('ordermethod') == 'cod') checked @endif />
                                                <label class="form-control-label" for="cod">
                                                    I would like to pay cash on delivery. <span class="fa fa-money-bill-alt"></span>
                                                </label>
                                            </div>
                                        @endif
                                    @endif
                                    <div class="form-checkbox mt-4 mb-5" wire:click="acceptterms">
                                        ...
                                        <label class="form-control-label" for="terms-condition">
                                            I have read and agree to the website <a href="/page/terms-and-conditions" style="color: blue">terms and conditions
                                    ...
                                    @if (Session::get('ordermethod') == 'cod')
                                        ...
                                        <div>
                                            ...
                                            <button wire:loading wire:target="disablebtn" class="btn btn-dark btn-rounded btn-order">
