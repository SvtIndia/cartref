            ...
            <div class="rating-form">
                <div class="questions">
                    <div class="question product-details">
                        ...
                        <div class="product">
                            <div class="image">
                                <img src="{{ Voyager::image($this->item->product->image) }}" alt="{{ $this->item->product->name }}">
                            </div>
                            <div class="info">
                                <div class="name">
                ...
                <a wire:click="closereturnmodel" class="btn btn-default btn-rounded"><i class="d-icon-arrow-left"></i> Cancel</a>
