                                    ...
                                    <ul class="widget-body filter-items">
                                        ...
                                        <li>
                                            <input type="checkbox"
                                                ...
                                                wire:model="producttypes.excludeoutofstock" value="excludeoutofstock">
                                ...
                                @if (Config::get('icrm.filters.subcategory') == 1)
                                    ...
                                    @isset($categories)
                                        @if (count($categories) > 0)
                                            ...
                                            ">
                                                            <a
                                                                href="{{ route('products.category', ['category' => $category->slug]) }}">{{ $category->name }}<i
                                            ...
                                            <div class="widget widget-collapsible" wire:ignore>
                                                ...
                                                <ul class="widget-body filter-items">
                                                    @foreach ($sizess as $key => $size)
                                                        <li>
                                                            <input type="checkbox" {{-- wire:key="sizes.{{ $size->id }}" --}}
                                    ...
                                    @if (isset($colorss))
                                        @if (count($colorss) > 0)
                                            <div class="widget widget-collapsible" wire:ignore>
                                                ...
                                                <ul class="widget-body filter-items"
                                                    @if (!$this->colors) style="display: none" @else style="display: block" @endif>
