            ...
            <aside class="col-lg-3 sidebar sidebar-fixed sidebar-toggle-remain shop-sidebar sticky-sidebar-wrapper">
                ...
                <div class="sidebar-content">
                    <div class="pin-wrapper" style="height: 1810.97px;">
                        <div class="sticky-sidebar" data-sticky-options="{'top': 10}" style="border-bottom: 0px none rgb(102, 102, 102); width: 272.5px;">
                        <div class="filter-actions mb-4">
                            ...
                            @if (count(request()->route()->parameters()) > 0 OR request('search'))
                            
                                <a href="{{ route('products') }}" class="filter-cleans" style="color: #ef5b2e;">Reset Filter</a>
                            @else
                        ...
                        <div class="widget widget-collapsible" wire:ignore>
                            ...
                            <ul class="widget-body filter-items">
                                <li>
                                    <input type="checkbox" 
                                    wire:key="producttypes.all.{{ time()+1 }}"
                                    wire:model="producttypes.all" 
                                    value="all"
                                ...
                                @if (Config::get('icrm.customize.feature') == 1)
                                    <li>
                                        ...
                                        wire:model="producttypes.customization" 
                                        value="customization"
                                        >
                                        Customizable
                                    </li>    
                                ...
                                @if (Config::get('icrm.showcase_at_home.feature') == 1)
                                    <li>
                                        ...
                                        wire:model="producttypes.showcaseathome" 
                                        value="showcaseathome"
                                        >
                                        Showcase At Home
                                    </li>
                                @endif
                            ...
                            @if (count($categories) > 0)
                                <div class="widget widget-collapsible">
                                    ...
                                    <ul class="widget-body filter-items search-ul">
                                        ...
                                        <li 
                                            class="
                                            @if (count($category->subcategory) > 0) with-ul @endif
                                            ">
                                            <a href="{{ route('products.category', ['category' => $category->slug]) }}">{{ $category->name }}<i class="fas fa-chevron-down"></i></a>
                            ...
                            <div class="widget widget-collapsible" wire:ignore>
                                ...
                                <div class="widget-body mt-3">
                                    <div class="priceranges">
                                        <input type="number" class="form-control" wire:model="minprice" placeholder="Min Price">
                                        <input type="number" class="form-control" wire:model="maxprice" placeholder="Max Price">
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        @if (isset($colorss))
                            @if (count($colorss) > 0)
                                <div class="widget widget-collapsible" wire:ignore>
                                    <h3 class="widget-title @if(!$this->colors) collapsed @endif">Color<span class="toggle-btn"></span></h3>
                                    <ul class="widget-body filter-items" @if(!$this->colors) style="display: none" @else style="display: block" @endif>
                        ...
                        @if (Config::get('icrm.filters.type') == 1)
                            ...
                            @if (isset($typess))
                                @if (count($typess) > 0)
                                    <div class="widget widget-collapsible" wire:ignore>
                                        <h3 class="widget-title @if(!$this->types) collapsed @endif">Type<span class="toggle-btn"></span></h3>
                                        <ul class="widget-body filter-items" @if(!$this->types) style="display: none" @endif>
                        ...
                        @if (Config::get('icrm.filters.mount') == 1)
                            ...
                            @if (isset($mountss))
                                @if (count($mountss) > 0)
                                    <div class="widget widget-collapsible" wire:ignore>
                                        <h3 class="widget-title @if(!$this->mounts) collapsed @endif">Mount<span class="toggle-btn"></span></h3>
                                        <ul class="widget-body filter-items" @if(!$this->mounts) style="display: none" @endif>
                        ...
                        @if (Config::get('icrm.filters.model') == 1)
                            ...
                            @if (isset($modelss))
                                @if (count($modelss) > 0)
                                    <div class="widget widget-collapsible" wire:ignore>
                                        <h3 class="widget-title @if(!$this->models) collapsed @endif">Model<span class="toggle-btn"></span></h3>
                                        <ul class="widget-body filter-items" @if(!$this->models) style="display: none" @endif>
                        ...
                        @if (Config::get('icrm.filters.voltage') == 1)
                            ...
                            @if (isset($voltagess))
                                @if (count($voltagess) > 0)
                                    <div class="widget widget-collapsible" wire:ignore>
                                        <h3 class="widget-title @if(!$this->voltages) collapsed @endif">Voltage<span class="toggle-btn"></span></h3>
                                        <ul class="widget-body filter-items" @if(!$this->voltages) style="display: none" @endif>
                        ...
                        @if (Config::get('icrm.filters.interface') == 1)
                            ...
                            @if (isset($interfacess))
                                @if (count($interfacess) > 0)
                                    <div class="widget widget-collapsible" wire:ignore>
                                        <h3 class="widget-title @if(!$this->interfaces) collapsed @endif">Interface<span class="toggle-btn"></span></h3>
                                        <ul class="widget-body filter-items" @if(!$this->interfaces) style="display: none" @endif>
                        ...
                        @if (Config::get('icrm.filters.style') == 1)
                            ...
                            @if (isset($styless))
                                @if (count($styless) > 0)
                                    <div class="widget widget-collapsible" wire:ignore>
                                        <h3 class="widget-title @if(!$this->styles) collapsed @endif">Style<span class="toggle-btn"></span></h3>
                                        <ul class="widget-body filter-items" @if(!$this->styles) style="display: none" @endif>
                        ...
                        @if (isset($brandss))
                            @if (count($brandss) > 0)
                                <div class="widget widget-collapsible" wire:ignore>
                                    <h3 class="widget-title @if(!$this->brands) collapsed @endif">Brand<span class="toggle-btn"></span></h3>
                                    <ul class="widget-body filter-items" @if(!$this->brands) style="display: none" @endif>
            ...
            <div class="col-lg-9 main-content">
                <nav class="toolbox sticky-toolbox sticky-content fix-top" id="catalogtopfilter">
                    <div class="toolbox-left">
                        <a href="#" class="toolbox-item left-sidebar-toggle btn btn-outline btn-primary btn-rounded btn-icon-right d-lg-none">
                    ...
                    <div class="toolbox-right">
                        ...
                        <div class="toolbox-item toolbox-layout">
                            <a wire:click="listmode" class="d-icon-mode-list btn-layout @if(Session::get('gridview') == 'listmode') active @endif"></a>
                            <a wire:click="boxmode" class="d-icon-mode-grid btn-layout @if(Session::get('gridview') != 'listmode') active @endif"></a>
                        </div>
                    </div>
                </nav>
                ...
                @if ($products->onFirstPage())
                    <div class="row">
                        <div class="showcase jumbotron">
                            <h1>Showcase At Home <a href="{{ route('showcase.introduction') }}"><span class="fas fa-info-circle" title="What is showcase at home?"></span></a></h1>
                            <p>Order <span>upto {{ Config::get('icrm.showcase_at_home.order_limit') }} products from any one vendor</span> and get the delivery done <span>within {{ Config::get('icrm.showcase_at_home.delivery_tat') }} working {{ Config::get('icrm.showcase_at_home.delivery_tat_name') }}</span> at your doorstep for just {{ Config::get('icrm.currency.icon') }} {{ Config::get('icrm.showcase_at_home.delivery_charges') }}/- service charges.</p>
                            ...
                            <p class="lead">
                                @if (Session::get('showcasecity') != null)
                                    @if (Session::get('showcasevendorid') != null)
                                        <p><span>Showing showcase at home products from <span>{{ Session::get('showcasevendor') }}</span> for {{ Session::get('showcasecity') }} city {{ Session::get('showcasepincode') }} area.</span></p>
                                    @else
                                        <p><span>Showing showcase at home products for {{ Session::get('showcasecity') }} city {{ Session::get('showcasepincode') }} area.</span></p>
                                    @endif
                                ...
                                @else
                                    <a href="{{ route('showcase.getstarted') }}" class="btn btn-primary btn-sm">Activate</a>
                                @endif
                            </p>
                        </div>
                    </div>
                            ...
                            <div class="product product-list">
                                <figure class="product-media">
                                    <a href="{{ route('product.slug', ['slug' => $product->slug]) }}">
                                        @php
                                            $firstcolorimage = App\Productcolor::where('status', 1)->where('product_id', $product->id)->first();
                                        ...
                                        @endphp
                                        <img src="{{ Voyager::image($firstcolorimage) }}" alt="{{ $product->name }}">
                                    </a>
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="ratings-container">
                                        <div class="ratings-full">
                                            ...
                                            {{ $product->productreviews()->where('status', 1)->sum('rate') / ($product->productreviews()->where('status', 1)->count() * 5) * 100 }}%
                                            @else   
                                            0%
                                            @endif"></span>
                                            <span class="tooltiptext tooltip-top"></span>
                                        </div>
                                        <a href="{{ route('product.slug', ['slug' => $product->slug]) }}" class="link-to-tab rating-reviews">
                                            ( @if($product->productreviews()) {{ $product->productreviews()->where('status', 1)->count() }} @else 0 @endif reviews )
                                        </a>
                                    </div>
                        ...
                        <div class="p-20 mb-4 bg-light rounded-3 text-center">
                            <div class="container-fluid py-5">
                                ...
                                <h1 class="display-5 fw-bold text-dark">
                                    ...
                                    @if (!empty(Session::get('showcasecity')))
                                        at {{ Session::get('showcasecity') }} {{ Session::get('showcasepincode') }} area.
                                    @endif
                                </h1>
                                <p class="fs-4 text-center">Reset filter and browse amazing products listed on our website</p>
                                <a href="{{ route('products') }}" class="btn btn-primary btn-lg" type="button">Reset Filter</a>
                                @if (!empty(Session::get('showcasecity')))
                                ...
                                <div class="product-wrap">
                                    <div class="product">
                                        ...
                                        <div class="product-details">
                                            ...
                                            <h3 class="product-name">
                                                <a href="{{ route('product.slug', ['slug' => $product->slug]) }}">{{ Str::limit($product->getTranslatedAttribute('name', App::getLocale(), 'en'), 45) }}</a>
                                            </h3>
                                            <div class="product-price">
                                                <ins class="new-price">{{ Config::get('icrm.currency.icon') }}{{ $product->offer_price }}/-</ins><del class="old-price">{{ Config::get('icrm.currency.icon') }}{{ $product->mrp }} </del>
                                                @if (Config::get('icrm.site_package.multi_vendor_store'))
                                ...
                                <div class="container-fluid py-5">
                                    ...
                                    @if (Session::get('showcasecity') != null)
                                        ...
                                        <form action="{{ route('showcase.deactivate') }}" method="post">
                                            @csrf
                                            <input type="hidden" class="form-control font-secondary form-solid" name="showcasepincode" id="showcasepincode" value="{{ Session::get('showcasepincode') }}" placeholder="Delivery pincode..." required="">
                                            <button class="btn btn-secondary btn-lg" type="submit" style="background: red; color: whitesmoke;">Deactivate Showcase At Home</button>
                                        </form>
                                        {{-- <a href="{{ route('products') }}" class="btn btn-danger btn-lg" style="background: red; color: whitesmoke;" type="button">Deactivate Showcase At Home</a> --}}
                                    @endif
                                </div>
