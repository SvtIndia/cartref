@if ($this->view == 'mobile-bottom')
    <a href="{{ route('showcase.introduction') }}" class="sticky-link showroom-dropdown-btn" style="position: relative;">
        <i>
    ...
    <div class="dropdown-box dropdown-box-mobile" style="left: 0;">
