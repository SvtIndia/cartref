                            ...
                            <div class="color-dropdown-wrapper">
                                <div class="color-dropdown-container">
                                    <div class="color-dropdown-container2">
                                        ...
                                        <button class="color-dropdown-button" type="button"
                                                tabindex="0"
                                            ...
                                            <div class="color-dropdown-div">
                                                ...
                                                <svg class="color-dropdown-svg"
                                                     id="sizes-list-chevron-up"
                                ...
                                <div class="color-dropdown-container">
                                    <div class="color-dropdown-container2">
                                        ...
                                        <div id="sizes-list" style="display: none;" class="size-list-wrapper">
                                            <div class="size-list-container">
                                                @foreach ($productsizesforcolor as $key => $size)
                                                    <div class="size-div" @if($this->size == $size->size) active @endif"
                                                    wire:attr="disabled">
...
<div class="description-wrapper">
    <div>
        ...
        <div class="desc-container">
            <h2 class="desc-container-h2">
                <button class="desc-container-btn" type="button" tabindex="0"
                        aria-expanded="false" onclick="slideToggle('desc-detail-list2')">
                                            <span class="desc-span">
                                                <span class="desc-span2">
                                                    <span class="desc-span3">
                        ...
                        <dl>
                            @if (!empty($product->type_id))
                                <div class="desc-content">
                                    ...
                                    <dd class="desc-value"
                                        role="definition">{{ $product->type_id }}</dd>
                                </div>
                            @endif
                            @if (!empty($product->mount_id))
                                <div class="desc-content">
                                    ...
                                    <dd class="desc-value"
                                        role="definition">{{ $product->mount_id }}</dd>
                                </div>
                            @endif
                            @if (!empty($product->modellist_id))
                                <div class="desc-content">
                                    ...
                                    <dd class="desc-value"
                                        role="definition">{{ $product->modellist_id }}</dd>
                                </div>
                            @endif
                            @if (!empty($product->voltage_id))
                                <div class="desc-content">
                                    ...
                                    <dd role="definition"
                                        class="desc-value">{{ $product->voltage_id }}</dd>
                                </div>
                            @endif
                            ...
                            @if (!empty($product->interface_id))
                                <div class="desc-content">
                                    ...
                                    <dd role="definition"
                                        class="desc-value">{{ $product->interface_id }}</dd>
                                </div>
                            @endif
                            ...
                            @if (!empty($product->displaytype_id))
                                <div class="desc-content">
                                    ...
                                    <dd role="definition"
                                        class="desc-value">{{ $product->displaytype_id }}</dd>
                                </div>
                            @endif
                            ...
                            @if (!empty($product->displaycolor_id))
                                <div class="desc-content">
                                    ...
                                    <dd role="definition"
                                        class="desc-value">{{ $product->displaycolor_id }}</dd>
                                </div>
                            @endif
                            ...
                            @if (!empty($product->pb_id))
                                <div class="desc-content">
                                    ...
                                    <dd role="definition"
                                        class="desc-value">{{ $product->pb_id }}</dd>
                                </div>
                            @endif
                            ...
                            @if (!empty($product->max_g))
                                <div class="desc-content">
                                    ...
                                    <dd role="definition"
                                        class="desc-value">{{ $product->max_g }}</dd>
                                </div>
                            @endif
                            ...
                            @if (!empty($product->gender_id))
                                <div class="desc-content">
                                    ...
                                    <dd role="definition"
                                        class="border-no desc-value">{{ $product->gender_id }}</dd>
                                </div>
                            @endif
                            ...
                            @if (!empty($product->style_id))
                                <div class="desc-content">
                                    ...
                                    <dd role="definition"
                                        class="border-no desc-value">{{ $product->style_id }}</dd>
                                </div>
                            @endif
                            ...
                            @if (!empty($product->brand_id))
                                <div class="desc-content">
                                    ...
                                    <dd role="definition"
                                        class="border-no desc-value">{{ $product->brand_id }}</dd>
                                </div>
                            @endif
                        </dl>
                    </div>
        ...
        <div class="desc-container">
            <h2 class="desc-container-h2">
                <button class="desc-container-btn" type="button" tabindex="0"
                        aria-expanded="false" onclick="slideToggle('desc-detail-list3')">
                                            <span class="desc-span">
                                                <span class="desc-span2">
                                                    <span class="desc-span3">
                    ...
                    <svg viewBox="0 0 24 24" width="1em" height="1em" style="display: none;"
                         fill="currentColor" class="color-dropdown-svg"
                         id="desc-detail-list3-chevron-down" focusable="false"
                         aria-hidden="true">
                        <path d="M2.64 15.994c0-.192.073-.384.219-.53l7.55-7.55a2.252 2.252 0 0 1 3.181 0l7.551 7.55a.75.75 0 1 1-1.06 1.06l-7.551-7.55a.751.751 0 0 0-1.06 0l-7.55 7.55a.75.75 0 0 1-1.28-.53z"></path>
                    </svg>

                    <svg class="color-dropdown-svg" id="desc-detail-list3-chevron-up"
                         viewBox="0 0 24 24" width="1em"
                         height="1em" fill="currentColor" focusable="false"
                         aria-hidden="true">
                        <path d="M2.859 7.475a.75.75 0 0 1 1.06 0l7.55 7.55a.751.751 0 0 0 1.06 0l7.551-7.55a.75.75 0 1 1 1.061 1.06l-7.55 7.55a2.252 2.252 0 0 1-3.182 0l-7.55-7.55a.748.748 0 0 1 0-1.06z"></path>
                        ...
                        <dl>
                            @if (Config::get('icrm.site_package.multi_vendor_store') == 1)
                                <div class="desc-content">
                                    ...
                                    <dd class="desc-value"
                                        role="definition">{{ $product->vendor->name }}</dd>
                                </div>
                            @endif
                            <div class="desc-content">
                                <dt class="desc-label" role="term">Brand:</dt>
                                <dd class="desc-value"
                                    role="definition">{{ $product->brand_id }}</dd>
                            </div>
                            @if (!empty($product->max_g))
                                <div class="desc-content">
                                    <dt class="desc-label" role="term">Maximum G+:</dt>
                                    <dd class="desc-value"
                                        role="definition">{{ $product->max_g }}</dd>
                                </div>
                            @endif
                            @if (!empty($product->cost_per_g))
                                <div class="desc-content">
                                    ...
                                    <dd class="desc-value"
                                        role="definition">{{ $product->cost_per_g }}</dd>
                                </div>
                            @endif
                            <div class="desc-content">
