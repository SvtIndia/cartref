                ...
                <div class="col-lg-12">
                    <article class="post-single">
                        <figure class="post-media">
                            <a href="#">
                                <img src="{{ Voyager::image($blog->image) }}" alt="{{ $blog->title }}" width="880" height="450">
                            </a>
                        </figure>
                        <div class="post-details">
                            <div class="post-meta">
                                by <a href="#" class="post-author">{{ env('APP_NAME') }}</a>
                    ...
                    <nav class="page-nav">
                        @isset($previous)
                            <a class="pager-link pager-link-prev" href="{{ route('blog', ['slug' => $previous->slug]) }}">
                                Previous Post
                        ...
                        @isset($next)
                            <a class="pager-link pager-link-next" href="{{ route('blog', ['slug' => $next->slug]) }}">
                                Go To Post
