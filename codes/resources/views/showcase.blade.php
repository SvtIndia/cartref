...
@section('content')
    ...
    <div class="page-content mt-2 pt-2">
        ...
        <section class="about-section pb-10 appear-animate fadeIn appear-animation-visible"
                 style="animation-duration: 1.2s;">
            <div class="container" style="padding: 0em 1em !important">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-4">
                                <div class="counter text-center text-dark">
                                    <span class="count-to" data-fromvalue="0"
                                          data-tovalue="{{ setting('showcase-widget.widget_1_count') }}"
                                          data-duration="900"
                                          data-delimiter=",">{{ setting('showcase-widget.widget_1_count') }}</span>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="counter text-center text-dark">
                                    <span class="count-to" data-fromvalue="0"
                                          data-tovalue="{{ setting('showcase-widget.widget_2_count') }}"
                                          data-duration="900"
                                          data-delimiter=",">{{ setting('showcase-widget.widget_2_count') }}</span>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="counter text-center text-dark">
                                    <span class="count-to" data-fromvalue="0"
                                          data-tovalue="{{ setting('showcase-widget.widget_3_count') }}"
                                          data-duration="900"
                                          data-delimiter=",">{{ setting('showcase-widget.widget_3_count') }}</span>
        ...
        @isset($components)
            @if (count($components) > 0)
                <section class="customer-section pb-10 appear-animate fadeIn appear-animation-visible"
                         style="animation-duration: 1.2s;">
                    <div class="container">
                        <div class="row">
                        @foreach ($components as $key => $component)
                            <div class="col-sm-3">
                                <div class="card">
                                    <img class="card-img-top" src="{{ Voyager::image($component->image) }}"
                                         alt="{{ $component->title_1 }}" >
                                    <div class="card-body">
                                        <h5 class="card-title1">{{ $component->title_1 }}</h5>
                                        <h6 class="card-title2">{{ $component->title_2 }}</h6>
                                        <p class="card-content">{{ $component->description }}</p>
                                        <a href="{{ $component->url }}" class="btn btn-primary">{{ $component->button }}</a>
                                    </div>
                                </div>
                            </div>
