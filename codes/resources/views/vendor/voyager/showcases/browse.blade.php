                    ...
                    <div class="panel-body">
                        ...
                        <div class="dashboard">
                            ...
                            @php
                                ...
                                }elseif(auth()->user()->hasRole(['Delivery Boy']))
                                {
                                    $showcases = App\Showcase::where('deliveryboy_id', auth()->user()->id)->get();
                                }elseif(auth()->user()->hasRole(['Delivery Head']))
                                {
                            ...
                            <a href="/{{ Config::get('icrm.admin_panel.prefix') }}/showcases?label=New Order">
                                <div class="item @if(request('label') == 'New Order') new_order active @endif">
                                    ...
                                    <div class="stat">
                                            <span class="count">{{ $showcases->where('order_status', 'New Order')->count() }}</span>
                                    </div>
                            ...
                            <a href="/{{ Config::get('icrm.admin_panel.prefix') }}/showcases?label=Out For Showcase">
                                <div class="item @if(request('label') == 'Out For Showcase') out_for_showcase active @endif">
                                    ...
                                    <div class="stat">
                                            <span class="count">{{ $showcases->where('order_status', 'Out For Showcase')->count() }}</span>
                                    </div>
                            ...
                            <a href="/{{ Config::get('icrm.admin_panel.prefix') }}/showcases?label=Showcased">
                                <div class="item @if(request('label') == 'Showcased') showcased active @endif">
                                    ...
                                    <div class="stat">
                                            <span class="count">{{ $showcases->whereIn('order_status', ['Showcased', 'Moved to Bag'])->count() }}</span>
                                    </div>
                            ...
                            <a href="/{{ Config::get('icrm.admin_panel.prefix') }}/showcases?label=Purchased">
                                <div class="item @if(request('label') == 'Purchased') purchased active @endif">
                                    ...
                                    <div class="stat">
                                            <span class="count">{{ $showcases->where('order_status', 'Purchased')->count() }}</span>
                                    </div>
                            ...
                            <a href="/{{ Config::get('icrm.admin_panel.prefix') }}/showcases?label=Returned">
                                <div class="item @if(request('label') == 'Returned') returned active @endif">
                                    ...
                                    <div class="stat">
                                            <span class="count">{{ $showcases->where('order_status', 'Returned')->count() }}</span>
                                    </div>
                            ...
                            <a href="/{{ Config::get('icrm.admin_panel.prefix') }}/showcases?label=Cancelled">
                                <div class="item @if(request('label') == 'Cancelled') cancelled active @endif">
                                    ...
                                    <div class="stat">
                                            <span class="count">{{ $showcases->where('order_status', 'Cancelled')->count() }}</span>
                                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr @if($data->order_status == 'Showcased') style="background: #fce5c1;" @elseif($data->order_status == 'Out For Showcase') style="background: #c2e6fa;" @elseif($data->order_status == 'Purchased' OR $data->order_status == 'Moved to Bag') style="background: #d4fae4;" @endif>
                                                ...
                                                @if (auth()->user()->hasRole(['Delivery Head', 'Delivery Boy', 'Client', 'admin']))
                                                    @if (request('label') == 'Showcased')
                                                        @if ($data->order_status == 'Showcased')
                                                            <a href="/showcase-at-home/my-orders/order/{{ $data->order_id }}/buynow" target="_blank" class="btn btn-sm btn-info"><i class="voyager-truck"></i> Order</a>
                                        ...
                                        <td>
                                            ...
                                            <div>
                                                <a href="/{{ Config::get('icrm.admin_panel.prefix') }}/showcases?order_id={{ $data->order_id }}">
                                                    {{ $data->order_id }}
                                                </a>
                                            </div>
                                        </td>
                                                    ...
                                                    @if (!empty($data->color))
                                                        ...
                                                        @if (!empty($colorimage))
                                                            @if (!empty($colorimage->main_image))
                                                                <img src="{{ Voyager::image($colorimage->main_image) }}" alt="{{ $data->product->name }}">
                                                            @else
                                                                <img src="{{ Voyager::image($data->product->image) }}" alt="{{ $data->product->name }}">    
                                                            @endif
                                                        @else
                                                            <img src="{{ Voyager::image($data->product->image) }}" alt="{{ $data->product->name }}">
                                                        @endif
                                        ...
                                        <td>
                                            ...
                                            <div>
                                                Service Charges: {{ Config::get('icrm.currency.icon').$data->order_value }}/-
                                            </div>
                                        </td>
                                        <td>
                                            Qty: {{ $data->qty }}
                                        ...
                                        <td>
                                            ...
                                            @if ($data->deliveryboy_id)
                                                ...
                                                <div>
                                                    ...
                                                    <a href="tel:{{ $data->deliveryboy->mobile }}"> {{ $data->deliveryboy->mobile }} </a>
                                                </div>
                                            @else
                                                <div>
                                                    Not Assigned
                                            ...
                                            @if ($data->deliveryhead_id)
                                                ...
                                                <div>
                                                    ...
                                                    <a href="tel:{{ $data->deliveryhead->mobile }}">{{ $data->deliveryhead->mobile }}</a>
                                                </div>
                                            @else
                                                <div>
                                                    Not Assigned
                                        ...
                                        <td>
                                            ...
                                            <div>
                                                <a href="tel:{{ $data->vendor->mobile }}">{{ $data->vendor->mobile }}</a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div>
                                                <a href="tel:{{ $data->customer_contact_number }}">{{ $data->customer_contact_number }}</a>
                                            </div>
                                            <div>
                                                <a href="tel:{{ $data->customer_alt_contact_number }}">{{ $data->customer_alt_contact_number }}</a>
                                            </div>

                                            @if ($data->customer_contact_number != $data->registered_contact_number)
                                            <div>
                                                <a href="tel:{{ $data->registered_contact_number }}">{{ $data->registered_contact_number }}</a>
                                            </div>
                                            @endif
                                        </td>
                                        @endif
