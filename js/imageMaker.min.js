...
(function (global, $) {
  ...
  var initialElements  = function(canvas_info) {
      ...
      <div class="wrapper-memes-preview-operations">
            ...
            <h3 style="color: white;">Customize here</h3>
      ...
      <br><br>
      <button  class="trigger-element first fileUpload btn btn-sm btn-success mr-5" target_element_triggered=".amm-addImage" id="amm-merge-image-trigger" style="width: 100%;">
            <input type="file" class="upload amm-addImage"  name="addImage" style="width: 60%;"> 
     ...
     <br>
     click on the media to append on the product image.
     <br>
     `+buildImagesMergeMemes+`
      ...
      <form class="form-generat-meme" action="meme-generator-callback" method="post" enctype="multipart/form-data">
        <button type="submit" class="mr-5 btn btn-default btn-danger form-submit reset_meme"><i class="d-icon-refresh"></i> `+canvas_info.i18n.resetText+`</button>
...
//   }
   ...
   // Add image to media and afer that on image
    function amm_add_image(event){
    ...
    // upload appended media to backend
  function uploadmedia(image_info)
  {
    var image_info = image_info.img.src;
    ...
    $.ajax({
        type: "POST",
        url: "/customization/customize/uploadmedia",
        data: {
            imgBase64: image_info,
            "customizeid": customizeidresult
        }
    }).done(function(o) {
        console.log('saved');
    });
  ...
  //      memeGeneratorData.memeGenerator = canvas_info.getImageData(0, 0, canvas_info.final_width, canvas_info.final_height);
      ...
      $.each(texts.keys, function(index, id) {
        ...
        //       .replace("image/png", "image/octet-stream");
            ...
            $.ajax({
                type: "POST",
                url: "/customization/customize/customized",
                data: {
                    imgBase64: image,
                    "customizeid": customizeidresult
                }
                ...
                // console.log('saved');
                return window.location.replace('/customization/customize/sharefiles?customizeid='+customizeidresult);
            });
